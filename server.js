...
const ACTIVE_STOCK_TTL = 3 * ONE_HOUR;

const COMPRESSION_RUN_INTERVAL_HOURS = 1;

const COMPRESSION_FIRST_CHECK_AGE = ONE_HOUR;
const COMPRESSION_FIRST_CHECK_INTERVAL = 4 * 60 * 1000;

const COMPRESSION_SECOND_CHECK_AGE = ONE_DAY;
const COMPRESSION_SECOND_CHECK_INTERVAL = 2 * ONE_HOUR;

const COMPRESSION_THIRD_CHECK_AGE = ONE_WEEK;
const COMPRESSION_THIRD_CHECK_INTERVAL = 12 * ONE_HOUR;

const COMPRESSION_FOURTH_CHECK_AGE = ONE_MONTH;
const COMPRESSION_FOURTH_CHECK_INTERVAL = 2 * ONE_DAY;
